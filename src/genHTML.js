...
module.exports = genHTML = (staffArray) =>{
    assembledCards = [];
    console.log(staffArray);
    for (let i = 0; i < staffArray.length; i++){
        const employee = staffArray[i];
    ...
    const teamProfile = genTeamProfile(joinCards);
    console.log(1,teamProfile);
    return teamProfile;
}

const genTeamProfile = function(joinCards){
